...
public class GUI extends JFrame implements ClientEventListener {
	...
	sendButton.addActionListener(new ActionListener() {
		public void actionPerformed(ActionEvent e) {
		    ...
		    if(!message.isEmpty()){
			client.sendMessage(new Command(Command.CommandType.CHAT, message));
		    }
		}
	});
		...
		gl_contentPane
				...
				gl_contentPane
					...
					.addGroup(
						gl_contentPane
							...
							.addComponent(createRoomButton, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
								Short.MAX_VALUE).addComponent(roomNameImput, Alignment.LEADING)))
			.addGap(18)
			.addGroup(
				gl_contentPane
					.createParallelGroup(Alignment.LEADING)
					.addGroup(
						gl_contentPane.createSequentialGroup().addComponent(textInput, GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
			...
			.addGroup(
				gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
					.addComponent(userList, GroupLayout.PREFERRED_SIZE, 106, GroupLayout.PREFERRED_SIZE).addComponent(startButton))));
		...
		gl_contentPane
			...
			.addGroup(
				gl_contentPane
					...
					.addComponent(textArea, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE)
					.addGroup(
						gl_contentPane
							.createSequentialGroup()
							.addComponent(roomList, GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(roomNameImput, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
					.addComponent(userList, GroupLayout.DEFAULT_SIZE, 291, Short.MAX_VALUE))
			.addPreferredGap(ComponentPlacement.RELATED)
			.addGroup(
				gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(createRoomButton).addComponent(startButton)
